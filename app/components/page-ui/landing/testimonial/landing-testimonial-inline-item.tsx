import { LandingRating } from '~/components/page-ui/landing/rating/landing-rating';
import { LandingAvatar } from '~/components/page-ui/landing/social-proof/landing-avatar';
