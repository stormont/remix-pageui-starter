...
import { TiktokIcon } from '~/components/page-ui/icons/tiktok-icon';
import { ThreadsIcon } from '~/components/page-ui/icons/threads-icon';
import { TwitterXIcon } from '~/components/page-ui/icons/x-icon';
...
export const Footer = ({ className }: { className?: string }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full flex flex-col md:flex-row justify-between gap-6 mt-12 p-6 container-wide">
      ...
      <div>
        ...
        <div className="py-8 px-2 flex flex-col items-center">
          ...
          <div className="w-full text-center lg:flex lg:justify-center p-4 mb-2 space-x-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>{` • `}</span>
            <a href="/">{siteConfig.businessName}</a>
            <span>{` • `}</span>
            <a href="https://shipixen.com">Built with Shipixen 🔁</a>
          </div>
        </div>
      </div>
    </footer>
